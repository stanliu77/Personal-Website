  ...
  return (
    <div style={{background: "rgb(35,39,65)",height:"100vh"}}>
      <Particles
        ...
        options={options}
      />
      <div className='header' >Hi my name is <p className='caption'>Chang Liu.</p><p className='caption'>Welcome to my website!</p>
      <div className='info'>Chang Liu sure does love web development. He likes things like JavaScript, CSS and BBQ. Wait. BBQ isn't part of web development. It should be though!</div>
      </div>
      <ul >
